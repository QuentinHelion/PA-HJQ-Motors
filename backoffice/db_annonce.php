...
<html>
	...
	<body>
		...
		<main>
			...
			<form action="../includes/delete.php?table=annonce" method="post">
			...
			<div class="d-flex justify-content-center">
				<div class="d-flex col-4">
					...
					<button class="btn btn-primary" onclick="listSearch('annonce')">Chercher</button>
				</div>
			</div>
			...
			<script>listSearch('annonce')</script>
